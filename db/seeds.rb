...
# Review.create(user_id: user1, product_id: product1, star_rating: 4, comment: "First product")
# Review.create(user_id: user2, product_id: product1, star_rating: 5, comment: "Second product")
